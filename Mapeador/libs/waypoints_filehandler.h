...
int waypts_export(FILE* src, unsigned int mode, const char* export_filename);
    /* Lee los datos de src y los pasa a un archivo legible y distinto especificado por mode
    * Modos (mediante flags binarias):
    *   - EXPORT_CSV: A csv con header, RFC4180
    */
